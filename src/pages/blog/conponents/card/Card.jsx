...
const Card = ({ blog }) => {
  ...
  return (
    <>
      <div className="container mx-auto flex" key={blog.id}>
        <div className="flex flex-col md:block shadow-black shadow-sm gap-10 p-2 ">
          ...
          <div className="content flex flex-col flex-5">
            ...
            <div className="title">
              <h1 className="text-start font-bold mb-3">{blog.title}</h1>
            </div>
            <div className="desc">
              <p className="font-light text-start mb-4">{blog.description}</p>
            </div>
            <Link to="/blogDetail">
